...
// Presets now use file paths to actual images.
// Ensure you have the corresponding image files in the public/assets/images/ directory.
// For example: public/assets/images/preset_paper.webp
